...
const CAFE_THEME_PALETTES: Record<
  Exclude<MenuColorThemeId, "default">,
  {
    paper: string;
    accent: string;
    accentSoft: string;
...
export function MenuTemplateSteakhouseCoffee({
  menu,
  locale,
}: {
  menu: MenuPublicDto;
  ...
  const themeId: MenuColorThemeId =
    ...
    (["default", "amber", "emerald", "bordeaux", "slate"] as MenuColorThemeId[]).includes(
      menu.colorTheme as MenuColorThemeId
    )
      ? (menu.colorTheme as MenuColorThemeId)
      : "default";
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/backgrounds/Steakhouse & Coffee.png')",
                          ...
                          {blocks.map(({ root: item, children: subItems }) => (
                            ...
                            >
                              <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1.5">
                                ...
                                {item.price != null && (
                                  <span
                                    className="shrink-0 font-forum text-base font-semibold tabular-nums sm:text-lg whitespace-nowrap"
