...
/** Icône accueil / dashboard (home). Style moderne stroke. */
...
/** Icône organisation / bâtiment (building). */
...
/** Icône menus / liste (clipboard-list style). */
export function IconMenuList({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
